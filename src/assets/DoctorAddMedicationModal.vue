    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="form-group">
            ...
            <input type="text" class="form-control" id="medicationName" placeholder="e.g: Nurofen">
        </div>

        <div class="form-group">
            <label for="sideEffect">Add Side Effect</label>
            <input type="text" class="form-control" id="sideEffect" placeholder="Description" v-model="sideEffect">
            <button class="btn btn-primary my-2 px-4" @click="addSideEffect">Add</button>

            <p class="pt-1 sideEffect" v-for="sideEf in sideEffects" :key="sideEf"
